      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Lembre-se: voce pode utilizar a variavel <code className="text-violet-400">{'{transcription}'}</code> no seu prompt para adicionar o conteudo da trancricao do video selecionado.
          </p>
        </div>
          ...
          <div className='space-y-2'>
            ...
            <div className='space-y-2'>
              ...
              <span className='block text-xs text-muted-foreground italic'>
                Voce podera custumizar essa opcao em breve
              </span>
            </div>
            <Separator/>

            <div className='space-y-4'>
              <Label>Temperatuta</Label>
              <Slider
              min={0}
              max={1}
              step={0.1}
